...
def _hp_ed_numba():
    ...
    imported by value: the kernel is default-ON and lazily loaded, opted out of
    with RECTIFY_HP_ED_NUMBA=0, and tests monkeypatch it. None here therefore
    means numba is genuinely unavailable, not merely unrequested."""
