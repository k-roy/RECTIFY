...
class TestSelectBestChimericFallback:
    ...
    (rectify.core.consensus.chimeric_consensus) not available in the test environment, so
    we mock it out.
    """

    def _make_chimeric_result(self, aligner_name, read):
        from rectify.core.consensus.chimeric_consensus import ChimericResult
    ...
    def test_fallback_on_reference_regression(self):
        ...
        with mock.patch(
            'rectify.core.consensus.chimeric_consensus.build_chimeric_cigar',
            return_value=(None, []),
        ), mock.patch(
            'rectify.core.consensus.chimeric_consensus._fallback_simple_selection',
